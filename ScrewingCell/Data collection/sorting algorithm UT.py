...
os.makedirs(r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Task data\UT", exist_ok=True)
os.makedirs(r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Extrinsic data\UT", exist_ok=True)
os.makedirs(r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Intrinsic data\UT", exist_ok=True)
...
move_files(n_s, taskdata_dir, r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Task data\N")
files_t = os.listdir(taskdata_dir)
for filename in files_t:
    if "csv" in filename:
        # Construct the full paths for the source and destination files
        src_path_t = os.path.join(taskdata_dir, filename)
        dest_path_t = os.path.join(r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Task data\UT", filename)
...
move_files(n_s, extrinsic_dir, r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Extrinsic data\N")
files_e = os.listdir(extrinsic_dir)
for filename in files_e:
    if "wav" in filename:
        src_path_e = os.path.join(extrinsic_dir, filename)
        dest_path_e = os.path.join(r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Extrinsic data\UT", filename)
...
move_files(n_s, intrinsic_dir, r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Intrinsic data\N")
files_i = os.listdir(intrinsic_dir)
for filename in files_i:
    if "csv" in filename:
        src_path_i = os.path.join(intrinsic_dir, filename)
        dest_path_i = os.path.join(r"C:\Users\AMRAN\OneDrive - Aalborg Universitet\8. semester\Projekt\CODE\Screwcell dataset\Intrinsic data\UT", filename)
